...
const RegisterFail = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ImageBackground
        source={AppImages.RedDot} // Replace with your background image path
        style={styles.backgroundImage}></ImageBackground>

      {/* Success Message */}
      <View style={{marginTop: 20}}>
        <Text style={styles.successMessage}>{t('Register UnSuccessful')}!</Text>
      </View>
