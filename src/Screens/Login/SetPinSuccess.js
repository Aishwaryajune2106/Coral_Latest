...
const SetPinSuccess = ({navigation}) => {
  ...
  const handleLoginNavigation = () => {
    navigation.navigate('DashBoardStack'); // Replace 'Login' with the name of your login screen route
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContentContainer}>
        <View style={styles.contentContainer}>
          <Text style={styles.title}>{t('Set PIN Number')}</Text>
          <View style={styles.iconContainer}>
            <View style={styles.iconBackground}>
              <Image
                source={AppImages.tick} // Replace with the password icon
                style={styles.icon}
              />
            </View>
          </View>
          <Text style={styles.message}>
            {t('Your Set PIN Number has been set successfully')}
          </Text>
