...
const Investstep3Individual = ({navigation}) => {
  ...
  const handleContinue = () => {
    if (validateFields()) {
      navigation.navigate('Investstep4IndividualScreen', {personalDetails});
    }
  };
      ...
      <View style={styles.whiteContainer}>
        <View>
          ...
          <View style={styles.securityContainer}>
            <Image
              source={AppImages.securitycard} // Add your security icon image here
            ...
            {selectedOption && (
              <>
                <View style={styles.personalDetails}>
                  <View style={styles.securityContainer}>
                    <Image
                      source={AppImages.Personal} // Add your security icon image here
                      style={styles.securityIcon}
                    />
...
export default Investstep3Individual;
