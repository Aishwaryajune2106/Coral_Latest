...
const WithdrawPinSet = ({navigation}) => {
  const handleLoginNavigation = () => {
    navigation.navigate('Withdraw'); // Replace 'Login' with the name of your login screen route
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContentContainer}>
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.message}>Now you can Log In back again.</Text>

          <TouchableOpacity
            onPress={handleLoginNavigation}
            style={styles.continueButton}>
            <Text style={styles.continueText}>Go Back to Withdraw</Text>
