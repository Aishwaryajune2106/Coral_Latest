...
const Futureoption4 = ({navigation, route}) => {
  ...
  console.log(selectedOptions, 'selectedOptionSSSS');
  ...
  const handleDownload = async () => {
    ...
    const requestBody = {
      ...
      investment: {
        ...
        project_name: lp_project,
        return_amount: lp_return,
        withdrawal_frequency: lp_wf,
      },
    ...
    console.log(requestBody, 'REQUESTTTedddT');
    ...
    try {
      ...
      const response = await axios.post(
        'https://coral.lunarsenterprises.com/wealthinvestment/user/future_options/invest',
        requestBody,
        {headers: headers},
      );
